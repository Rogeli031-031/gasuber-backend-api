...
exports.pedidosRouter = (0, express_1.Router)();
exports.pedidosRouter.get("/", async (_req, res) => {
    const { rows } = await db_1.db.query(`SELECT id, telefono_origen, cliente_nombre, direccion_texto, litros_solicitados, estado, prioridad, created_at
     FROM pedidos
     ORDER BY created_at DESC
     LIMIT 50`);
    res.json({ ok: true, items: rows });
});
exports.pedidosRouter.get("/:id", async (req, res) => {
...
exports.pedidosRouter.post("/", async (req, res) => {
    const { telefono_origen, cliente_nombre = null, direccion_texto, litros_solicitados = null, prioridad = 3, } = req.body ?? {};
    ...
    const litrosNum = litros_solicitados === null || litros_solicitados === undefined
        ? null
    ...
    const { rows } = await db_1.db.query(`INSERT INTO pedidos (telefono_origen, cliente_nombre, direccion_texto, litros_solicitados, prioridad)
     VALUES ($1, $2, $3, $4, $5)
