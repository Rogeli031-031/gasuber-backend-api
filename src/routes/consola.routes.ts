...
import {
  ...
  getTelemetriaAutotanqueConsola,
  getEventosConsola,
  getPedidosConsola,
  ...
  getInformacionAutotanqueAlarmasConsola,
...
consolaRoutes.get("/informacion-autotanque-alarmas", getInformacionAutotanqueAlarmasConsola);
...
consolaRoutes.get(
  "/telemetria-autotanque/:autotanqueId",
  getTelemetriaAutotanqueConsola
);
